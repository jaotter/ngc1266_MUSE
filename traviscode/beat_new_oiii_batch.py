...
object_name = 'mrk926'
cube_filename = 'MRK926_MUSE.fits'

final_out_dir = object_name+"_oiii_out"
...
output_directory = object_name + '_spaxel_coord_files/'  # Ensure object_name is defined
...
def main0():
    ...
    cont_instructions = {
        'form': 'model',
        'cont_poly': 1,
        'continuum1': (5215,5225),
        'continuum2': (5280,5295),
    }

   # fit_instructions = {
    #    'line1': {'name': 'halpha', 'wave': 6562.8, 'minwave': 6615, 'wave_range': 20.0, 'flux_free': True},
    ...
    processor = DataProcessor(
        cube_path='MRK926_MUSE.fits',
        spec_dir='mrk926_spaxel_coord_files/',
        out_dir='mrk926_spaxel_coord_files_oiii_out/',
